...
class RandomForests:
    ...
    def lerDados(self,X_resampled, y_resampled, feature_names):
        print("\nRANDOM FOREST")
        # Inicializa o KFold
        ...
        # Inicializa a lista para armazenar a importância das variáveis
        feature_importances = []
        ...
        for train_index, test_index in kf.split(X_resampled):
            ...
            feature_importances.append(modelo.feature_importances_)
        ...
        # Calcula a média da importância das variáveis
        feature_importances = np.mean(feature_importances, axis=0)


        # Obtém os índices das variáveis em ordem decrescente de importância
        ...
        for i, index in enumerate(indices):
            print(f"{i+1}. Variável '{feature_names[index]}': {feature_importances[index]}")
